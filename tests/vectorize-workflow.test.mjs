...
test("PreviewにはVectorizeをbind・同期せずProductionだけを扱う", async () => {
  ...
  assert.match(wrangler, /"production":\s*\{[\s\S]*?"SEARCH_ENABLED": "true"/u);
...
test("Pages binding・sync allowlist・workflowをProduction indexへ限定する", async () => {
